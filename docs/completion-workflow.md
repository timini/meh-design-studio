...
The requested 240–3000 Hz midrange and GBP 300 per-speaker budget remain the
practical design challenge. The existing provisional ±3 dB screening band is
...
Work in progress starts with the shared ring topology, then freeform geometry and
adaptive search. Preserve the historical R1 diagnostic failures; do not relabel
